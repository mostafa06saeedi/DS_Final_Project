...
template <typename T>
typename DoublyLinkedList<T>::Node *DoublyLinkedList<T>::find(bool (*predicate)(const T &))
{
    Node *curr = head;
    while (curr)
    {
...
template <typename T>
void DoublyLinkedList<T>::traverseForward(void (*fn)(T &))
{
    Node *curr = head;
    while (curr)
    {
...
template <typename T>
void DoublyLinkedList<T>::traverseBackward(void (*fn)(T &))
{
    Node *curr = tail;
    while (curr)
    {
